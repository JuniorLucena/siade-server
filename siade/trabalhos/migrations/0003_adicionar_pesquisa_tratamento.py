...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Visita.imovel_tratado'
        db.add_column(u'trabalhos_visita', 'imovel_tratado',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visita.depositos_tratados'
        db.add_column(u'trabalhos_visita', 'depositos_tratados',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visita.depositos_eliminados'
        db.add_column(u'trabalhos_visita', 'depositos_eliminados',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visita.larvicida'
        db.add_column(u'trabalhos_visita', 'larvicida',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visita.qtd_larvicida'
        db.add_column(u'trabalhos_visita', 'qtd_larvicida',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visita.A1'
        db.add_column(u'trabalhos_visita', 'A1',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visita.A2'
        db.add_column(u'trabalhos_visita', 'A2',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visita.B'
        db.add_column(u'trabalhos_visita', 'B',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visita.C'
        db.add_column(u'trabalhos_visita', 'C',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visita.D1'
        db.add_column(u'trabalhos_visita', 'D1',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visita.D2'
        db.add_column(u'trabalhos_visita', 'D2',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visita.E'
        db.add_column(u'trabalhos_visita', 'E',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visita.amostra_inicial'
        db.add_column(u'trabalhos_visita', 'amostra_inicial',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visita.amostra_final'
        db.add_column(u'trabalhos_visita', 'amostra_final',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visita.tubitos'
        db.add_column(u'trabalhos_visita', 'tubitos',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Visita.imovel_tratado'
        db.delete_column(u'trabalhos_visita', 'imovel_tratado')

        # Deleting field 'Visita.depositos_tratados'
        db.delete_column(u'trabalhos_visita', 'depositos_tratados')

        # Deleting field 'Visita.depositos_eliminados'
        db.delete_column(u'trabalhos_visita', 'depositos_eliminados')

        # Deleting field 'Visita.larvicida'
        db.delete_column(u'trabalhos_visita', 'larvicida')

        # Deleting field 'Visita.qtd_larvicida'
        db.delete_column(u'trabalhos_visita', 'qtd_larvicida')

        # Deleting field 'Visita.A1'
        db.delete_column(u'trabalhos_visita', 'A1')

        # Deleting field 'Visita.A2'
        db.delete_column(u'trabalhos_visita', 'A2')

        # Deleting field 'Visita.B'
        db.delete_column(u'trabalhos_visita', 'B')

        # Deleting field 'Visita.C'
        db.delete_column(u'trabalhos_visita', 'C')

        # Deleting field 'Visita.D1'
        db.delete_column(u'trabalhos_visita', 'D1')

        # Deleting field 'Visita.D2'
        db.delete_column(u'trabalhos_visita', 'D2')

        # Deleting field 'Visita.E'
        db.delete_column(u'trabalhos_visita', 'E')

        # Deleting field 'Visita.amostra_inicial'
        db.delete_column(u'trabalhos_visita', 'amostra_inicial')

        # Deleting field 'Visita.amostra_final'
        db.delete_column(u'trabalhos_visita', 'amostra_final')

        # Deleting field 'Visita.tubitos'
        db.delete_column(u'trabalhos_visita', 'tubitos')
    ...
    models = {
        ...
        u'trabalhos.visita': {
            ...
            'data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 19, 0, 0)'}),
            ...
            'qtd_larvicida': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
