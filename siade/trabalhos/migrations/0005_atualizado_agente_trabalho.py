...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Agente.codigo'
        db.add_column(u'trabalhos_agente', 'codigo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Agente.nascimento'
        db.add_column(u'trabalhos_agente', 'nascimento',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ciclo.fechado_em'
        db.add_column(u'trabalhos_ciclo', 'fechado_em',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Agente.codigo'
        db.delete_column(u'trabalhos_agente', 'codigo')

        # Deleting field 'Agente.nascimento'
        db.delete_column(u'trabalhos_agente', 'nascimento')

        # Deleting field 'Ciclo.fechado_em'
        db.delete_column(u'trabalhos_ciclo', 'fechado_em')
    ...
    models = {
        ...
        u'trabalhos.agente': {
            ...
            'codigo': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
        ...
        u'trabalhos.visita': {
            ...
            'data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 23, 0, 0)'}),
