...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Trabalho.campanha'
        db.delete_column(u'trabalhos_trabalho', 'campanha_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Trabalho.campanha'
        raise RuntimeError("Cannot reverse this migration. 'Trabalho.campanha' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Trabalho.campanha'
        db.add_column(u'trabalhos_trabalho', 'campanha',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='trabalhos', to=orm['trabalhos.Campanha']),
                      keep_default=False)
