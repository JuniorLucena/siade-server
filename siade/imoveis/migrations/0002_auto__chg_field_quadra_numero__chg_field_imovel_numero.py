...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quadra.numero'
        db.alter_column(u'imoveis_quadra', 'numero', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Imovel.numero'
        db.alter_column(u'imoveis_imovel', 'numero', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

    def backwards(self, orm):

        # Changing field 'Quadra.numero'
        db.alter_column(u'imoveis_quadra', 'numero', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Imovel.numero'
        db.alter_column(u'imoveis_imovel', 'numero', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
