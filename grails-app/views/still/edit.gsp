...
<html>
	...
	<body>
		<a href="#edit-still" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-still" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:stillInstance, action:'update']" method="PUT" >
