...
class BlockController {
    ...
    def save(Block blockInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'blockInstance.label', default: 'Block'), blockInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'blockInstance.label', default: 'Block'), params.id])
                redirect action: "index", method: "GET"
            }
